...
namespace DungeonMasterHelper
{
	...
	public static class Data
	{
		...
		public static class Treasure
		{
			...
			{
				string coins = (roll(12, 6) * 1000).ToString() + " gp, " + (roll(8, 6) * 10).ToString() + " pp";
				...
				switch (roll(1, 100))
				{
					...
					case 5:
						...
						if (withDetails)
						{
							res += ", " + getMultipleRandomFrom(roll(3, 6), gemstones1000gp) + ", " + getMultipleRandomFrom(roll(1, 8), magic_item_table_c);
						}
						else
						{
							res += ", " + roll(3, 6).ToString() + " 1,000 gp gems, roll " + roll(1, 8).ToString() + " times on Magic Item Table C";
						}
					...
					case 8:
						...
						if (withDetails)
						{
							res += ", " + getMultipleRandomFrom(roll(1, 10), art_objects2500gp) + ", " + getMultipleRandomFrom(roll(1, 8), magic_item_table_c);
						}
						else
						{
							res += ", " + roll(1, 10).ToString() + " 2,500 gp art objects, roll " + roll(1, 8).ToString() + " times on Magic Item Table C";
						}
					...
					case 11:
						...
						if (withDetails)
						{
							res += ", " + getMultipleRandomFrom(roll(1, 4), art_objects7500gp) + ", " + getMultipleRandomFrom(roll(1, 8), magic_item_table_c);
						}
						else
						{
							res += ", " + roll(1, 4).ToString() + " 7,500 gp art objects, roll " + roll(1, 8).ToString() + " times on Magic Item Table C";
						}
					...
					case 14:
						...
						if (withDetails)
						{
							res += ", " + getMultipleRandomFrom(roll(1, 8), gemstones5000gp) + ", " + getMultipleRandomFrom(roll(1, 8), magic_item_table_c);
						}
						else
						{
							res += ", " + roll(1, 8).ToString() + " 5,000 gp gems, roll " + roll(1, 8).ToString() + " times on Magic Item Table C";
						}
					...
					case 22:
						...
						if (withDetails)
						{
							res += ", " + getMultipleRandomFrom(roll(3, 6), gemstones1000gp) + ", " + getMultipleRandomFrom(roll(1, 6), magic_item_table_d);
						}
						else
						{
							res += ", " + roll(3, 6).ToString() + " 1,000 gp gems, roll " + roll(1, 6).ToString() + " times on Magic Item Table D";
						}
					...
					case 30:
						...
						if (withDetails)
						{
							res += ", " + getMultipleRandomFrom(roll(1, 10), art_objects2500gp) + ", " + getMultipleRandomFrom(roll(1, 6), magic_item_table_d);
						}
						else
						{
							res += ", " + roll(1, 10).ToString() + " 2,500 gp art objects, roll " + roll(1, 6).ToString() + " times on Magic Item Table D";
						}
					...
					case 38:
						...
						if (withDetails)
						{
							res += ", " + getMultipleRandomFrom(roll(1, 4), art_objects7500gp) + ", " + getMultipleRandomFrom(roll(1, 6), magic_item_table_d);
						}
						else
						{
							res += ", " + roll(1, 4).ToString() + " 7,500 gp art objects, roll " + roll(1, 6).ToString() + " times on Magic Item Table D";
						}
					...
					case 46:
						...
						if (withDetails)
						{
							res += ", " + getMultipleRandomFrom(roll(1, 8), gemstones5000gp) + ", " + getMultipleRandomFrom(roll(1, 6), magic_item_table_d);
						}
						else
						{
							res += ", " + roll(1, 8).ToString() + " 5,000 gp gems, roll " + roll(1, 6).ToString() + " times on Magic Item Table D";
						}
					...
					case 52:
						...
						if (withDetails)
						{
							res += ", " + getMultipleRandomFrom(roll(3, 6), gemstones1000gp) + ", " + getMultipleRandomFrom(roll(1, 6), magic_item_table_e);
						}
						else
						{
							res += ", " + roll(3, 6).ToString() + " 1,000 gp gems, roll " + roll(1, 6).ToString() + " times on Magic Item Table E";
						}
					...
					case 58:
						...
						if (withDetails)
						{
							res += ", " + getMultipleRandomFrom(roll(1, 10), art_objects2500gp) + ", " + getMultipleRandomFrom(roll(1, 6), magic_item_table_e);
						}
						else
						{
							res += ", " + roll(1, 10).ToString() + " 2,500 gp art objects, roll " + roll(1, 6).ToString() + " times on Magic Item Table E";
						}
					...
					case 63:
						...
						if (withDetails)
						{
							res += ", " + getMultipleRandomFrom(roll(1, 4), art_objects7500gp) + ", " + getMultipleRandomFrom(roll(1, 6), magic_item_table_e);
						}
						else
						{
							res += ", " + roll(1, 4).ToString() + " 7,500 gp art objects, roll " + roll(1, 6).ToString() + " times on Magic Item Table E";
						}
					...
					case 68:
						...
						if (withDetails)
						{
							res += ", " + getMultipleRandomFrom(roll(1, 8), gemstones5000gp) + ", " + getMultipleRandomFrom(roll(1, 6), magic_item_table_e);
						}
						else
						{
							res += ", " + roll(1, 8).ToString() + " 5,000 gp gems, roll " + roll(1, 6).ToString() + " times on Magic Item Table E";
						}
					...
					case 69:
						...
						if (withDetails)
						{
							res += ", " + getMultipleRandomFrom(roll(3, 6), gemstones1000gp) + ", " + getMultipleRandomFrom(roll(1, 4), magic_item_table_g);
						}
						else
						{
							res += ", " + roll(3, 6).ToString() + " 1,000 gp gems, roll " + roll(1, 4).ToString() + " times on Magic Item Table G";
						}
					...
					case 70:
						...
						if (withDetails)
						{
							res += ", " + getMultipleRandomFrom(roll(1, 10), art_objects2500gp) + ", " + getMultipleRandomFrom(roll(1, 4), magic_item_table_g);
						}
						else
						{
							res += ", " + roll(1, 10).ToString() + " 2,500 gp art objects, roll " + roll(1, 4).ToString() + " times on Magic Item Table G";
						}
					...
					case 71:
						...
						if (withDetails)
						{
							res += ", " + getMultipleRandomFrom(roll(1, 4), art_objects7500gp) + ", " + getMultipleRandomFrom(roll(1, 4), magic_item_table_g);
						}
						else
						{
							res += ", " + roll(1, 4).ToString() + " 7,500 gp art objects, roll " + roll(1, 4).ToString() + " times on Magic Item Table G";
						}
					...
					case 72:
						...
						if (withDetails)
						{
							res += ", " + getMultipleRandomFrom(roll(1, 8), gemstones5000gp) + ", " + getMultipleRandomFrom(roll(1, 4), magic_item_table_g);
						}
						else
						{
							res += ", " + roll(1, 8).ToString() + " 5,000 gp gems, roll " + roll(1, 4).ToString() + " times on Magic Item Table G";
						}
					...
					case 74:
						...
						if (withDetails)
						{
							res += ", " + getMultipleRandomFrom(roll(3, 6), gemstones1000gp) + ", " + getMultipleRandomFrom(roll(1, 4), magic_item_table_h);
						}
						else
						{
							res += ", " + roll(3, 6).ToString() + " 1,000 gp gems, roll " + roll(1, 4).ToString() + " times on Magic Item Table H";
						}
					...
					case 76:
						...
						if (withDetails)
						{
							res += ", " + getMultipleRandomFrom(roll(1, 10), art_objects2500gp) + ", " + getMultipleRandomFrom(roll(1, 4), magic_item_table_h);
						}
						else
						{
							res += ", " + roll(1, 10).ToString() + " 2,500 gp art objects, roll " + roll(1, 4).ToString() + " times on Magic Item Table H";
						}
					...
					case 78:
						...
						if (withDetails)
						{
							res += ", " + getMultipleRandomFrom(roll(1, 4), art_objects7500gp) + ", " + getMultipleRandomFrom(roll(1, 4), magic_item_table_h);
						}
						else
						{
							res += ", " + roll(1, 4).ToString() + " 7,500 gp art objects, roll " + roll(1, 4).ToString() + " times on Magic Item Table H";
						}
					...
					case 80:
						...
						if (withDetails)
						{
							res += ", " + getMultipleRandomFrom(roll(1, 8), gemstones5000gp) + ", " + getMultipleRandomFrom(roll(1, 4), magic_item_table_h);
						}
						else
						{
							res += ", " + roll(1, 8).ToString() + " 5,000 gp gems, roll " + roll(1, 4).ToString() + " times on Magic Item Table H";
						}
					...
					case 85:
						...
						if (withDetails)
						{
							res += ", " + getMultipleRandomFrom(roll(3, 6), gemstones1000gp) + ", " + getMultipleRandomFrom(roll(1, 4), magic_item_table_i);
						}
						else
						{
							res += ", " + roll(3, 6).ToString() + " 1,000 gp gems, roll " + roll(1, 4).ToString() + " times on Magic Item Table I";
						}
					...
					case 90:
						...
						if (withDetails)
						{
							res += ", " + getMultipleRandomFrom(roll(1, 10), art_objects2500gp) + ", " + getMultipleRandomFrom(roll(1, 4), magic_item_table_i);
						}
						else
						{
							res += ", " + roll(1, 10).ToString() + " 2,500 gp art objects, roll " + roll(1, 4).ToString() + " times on Magic Item Table I";
						}
					...
					case 95:
						...
						if (withDetails)
						{
							res += ", " + getMultipleRandomFrom(roll(1, 4), art_objects7500gp) + ", " + getMultipleRandomFrom(roll(1, 4), magic_item_table_i);
						}
						else
						{
							res += ", " + roll(1, 4).ToString() + " 7,500 gp art objects, roll " + roll(1, 4).ToString() + " times on Magic Item Table I";
						}
					...
					case 100:
						...
						if (withDetails)
						{
							res += ", " + getMultipleRandomFrom(roll(1, 8), gemstones5000gp) + ", " + getMultipleRandomFrom(roll(1, 4), magic_item_table_i);
						}
						else
						{
							res += ", " + roll(1, 8).ToString() + " 5,000 gp gems, roll " + roll(1, 4).ToString() + " times on Magic Item Table I";
						}
		...
		{
			public static readonly string[] urban_chase_complications =
			{
				"A large obstacle such as a horse or car blocks your way. Make a DC 15 Dexterity (Acorbatics) check to get past the obstacle. On a failed check, the obstacle counts as 10 fet of difficult terrain.",
				"A crowd blocks yoru way. Make a DC 10 Strength (Athletics) or Dexterity (Acrobatics) check (your choice) to make your way through the crowd unimpeded. On a failed check, the crowd counts as 10 feet of difficult terrain.",
				"A larget stained-glass window or similar barrier blocks your path. Make a DC 10 Strength saving throw to smash through the barrier and keep going. On a failed save, you bounce off the barrier and fall prone.",
				...
				// 11-20
				"No complication.", "No complication.", "No complication.", "No complication.", "No complication.",
				"No complication.", "No complication.", "No complication.", "No complication.", "No complication.",
			};

			public static readonly string[] wilderness_chase_complications =
			{
				...
				"Uneven ground threatens to slow your progress. Make a DC 10 Dexterity (Acrobatics) check to navigate the area. On a failed check, the ground coutns as 10 feet of difficult terrain.",
				"You run through a swarm of insects (see the Monster Manual for game statistics, with the DM choosing whiever kind of insects makes the most sens). The swarm makes an opportunity attack against you (+3 to hit; 4d4 piercing damage on a hit).",
				...
				"Your path takes you near a patch of razorvine. Make a DC 15 Dexterity saving thro or use 10 feet of movement (your choice) to avoid the razorvine. On a failed save, you take 1d10 slashing damage.",
			...
			public static readonly string[] poisons_item =
			{
				"Assassin's blood",
				"Burnt othur fumes",
			...
			public static readonly string[] poisons_type =
			{
				"Ingested",
				"Inhaled",
				"Contact",
			...
			public static readonly string[] poisons_price_per_dose =
			{
				"150 gp",
				"500 gp",
				"200 gp",
			...
			public static readonly string[][] poisons =
			{
				poisons_item,
				poisons_type,
			...
			public static readonly string[] short_term_madness =
			{
				// 01-20
				"The character retreats into his or her mind and becomes paralyzed. The effect ends if the character takes any damage.","The character retreats into his or her mind and becomes paralyzed. The effect ends if the character takes any damage.",
				"The character retreats into his or her mind and becomes paralyzed. The effect ends if the character takes any damage.","The character retreats into his or her mind and becomes paralyzed. The effect ends if the character takes any damage.",
				"The character retreats into his or her mind and becomes paralyzed. The effect ends if the character takes any damage.","The character retreats into his or her mind and becomes paralyzed. The effect ends if the character takes any damage.",
				"The character retreats into his or her mind and becomes paralyzed. The effect ends if the character takes any damage.","The character retreats into his or her mind and becomes paralyzed. The effect ends if the character takes any damage.",
				"The character retreats into his or her mind and becomes paralyzed. The effect ends if the character takes any damage.","The character retreats into his or her mind and becomes paralyzed. The effect ends if the character takes any damage.",
				...
				"The character retreats into his or her mind and becomes paralyzed. The effect ends if the character takes any damage.","The character retreats into his or her mind and becomes paralyzed. The effect ends if the character takes any damage.",
				// 21-30
				"The character becomes incapacitated and spends the duration screaming, laughing or weeping.", "The character becomes incapacitated and spends the duration screaming, laughing or weeping.",
				"The character becomes incapacitated and spends the duration screaming, laughing or weeping.", "The character becomes incapacitated and spends the duration screaming, laughing or weeping.",
				"The character becomes incapacitated and spends the duration screaming, laughing or weeping.", "The character becomes incapacitated and spends the duration screaming, laughing or weeping.",
				"The character becomes incapacitated and spends the duration screaming, laughing or weeping.", "The character becomes incapacitated and spends the duration screaming, laughing or weeping.",
				"The character becomes incapacitated and spends the duration screaming, laughing or weeping.", "The character becomes incapacitated and spends the duration screaming, laughing or weeping.",
				// 31-40
				"The character becomes frightened and must use his or her action and movement each round to flee from the source of hte fear.", "The character becomes frightened and must use his or her action and movement each round to flee from the source of hte fear.",
				"The character becomes frightened and must use his or her action and movement each round to flee from the source of hte fear.", "The character becomes frightened and must use his or her action and movement each round to flee from the source of hte fear.",
				"The character becomes frightened and must use his or her action and movement each round to flee from the source of hte fear.", "The character becomes frightened and must use his or her action and movement each round to flee from the source of hte fear.",
				"The character becomes frightened and must use his or her action and movement each round to flee from the source of hte fear.", "The character becomes frightened and must use his or her action and movement each round to flee from the source of hte fear.",
				"The character becomes frightened and must use his or her action and movement each round to flee from the source of hte fear.", "The character becomes frightened and must use his or her action and movement each round to flee from the source of hte fear.",
				// 41-50
				"The character begins babling and is incapable of normal speech or spellcasting.", "The character begins babling and is incapable of normal speech or spellcasting.",
				"The character begins babling and is incapable of normal speech or spellcasting.", "The character begins babling and is incapable of normal speech or spellcasting.",
				"The character begins babling and is incapable of normal speech or spellcasting.", "The character begins babling and is incapable of normal speech or spellcasting.",
				"The character begins babling and is incapable of normal speech or spellcasting.", "The character begins babling and is incapable of normal speech or spellcasting.",
				"The character begins babling and is incapable of normal speech or spellcasting.", "The character begins babling and is incapable of normal speech or spellcasting.",
				// 51-60
				"The character must use his or her action each round to attack the nearest creature.", "The character must use his or her action each round to attack the nearest creature.",
				"The character must use his or her action each round to attack the nearest creature.", "The character must use his or her action each round to attack the nearest creature.",
				"The character must use his or her action each round to attack the nearest creature.", "The character must use his or her action each round to attack the nearest creature.",
				"The character must use his or her action each round to attack the nearest creature.", "The character must use his or her action each round to attack the nearest creature.",
				"The character must use his or her action each round to attack the nearest creature.", "The character must use his or her action each round to attack the nearest creature.",
				// 61-70
				"The character experiences vivid hallucinations and has disadvantage on ability checks.", "The character experiences vivid hallucinations and has disadvantage on ability checks.",
				"The character experiences vivid hallucinations and has disadvantage on ability checks.", "The character experiences vivid hallucinations and has disadvantage on ability checks.",
				"The character experiences vivid hallucinations and has disadvantage on ability checks.", "The character experiences vivid hallucinations and has disadvantage on ability checks.",
				"The character experiences vivid hallucinations and has disadvantage on ability checks.", "The character experiences vivid hallucinations and has disadvantage on ability checks.",
				"The character experiences vivid hallucinations and has disadvantage on ability checks.", "The character experiences vivid hallucinations and has disadvantage on ability checks.",
				// 71-75
				"The character does whatever anyone tells him or her to do that isn't obviously self-destructive.", "The character does whatever anyone tells him or her to do that isn't obviously self-destructive.",
				"The character does whatever anyone tells him or her to do that isn't obviously self-destructive.", "The character does whatever anyone tells him or her to do that isn't obviously self-destructive.",
				"The character does whatever anyone tells him or her to do that isn't obviously self-destructive.", 
				// 76-80
				"The character experiences an overpowering urge to eat something strange such as dirt, slime, or offal.", "The character experiences an overpowering urge to eat something strange such as dirt, slime, or offal.",
				"The character experiences an overpowering urge to eat something strange such as dirt, slime, or offal.", "The character experiences an overpowering urge to eat something strange such as dirt, slime, or offal.",
				"The character experiences an overpowering urge to eat something strange such as dirt, slime, or offal.",
				// 81-90
				"The character is stunned.", "The character is stunned.", "The character is stunned.", "The character is stunned.", "The character is stunned.",
				"The character is stunned.", "The character is stunned.", "The character is stunned.", "The character is stunned.", "The character is stunned.",
				// 91-100
				"The character falls unconscious.", "The character falls unconscious.", "The character falls unconscious.", "The character falls unconscious.", "The character falls unconscious.",
				"The character falls unconscious.", "The character falls unconscious.", "The character falls unconscious.", "The character falls unconscious.", "The character falls unconscious."
			};

			public static readonly string[] long_term_madness =
			{
				// 01-10
				"The character feels compelled to repeat a specific activity over and over, such as washing hands, touching things, praying, or counting coins.", "The character feels compelled to repeat a specific activity over and over, such as washing hands, touching things, praying, or counting coins.",
				"The character feels compelled to repeat a specific activity over and over, such as washing hands, touching things, praying, or counting coins.", "The character feels compelled to repeat a specific activity over and over, such as washing hands, touching things, praying, or counting coins.",
				"The character feels compelled to repeat a specific activity over and over, such as washing hands, touching things, praying, or counting coins.", "The character feels compelled to repeat a specific activity over and over, such as washing hands, touching things, praying, or counting coins.",
				"The character feels compelled to repeat a specific activity over and over, such as washing hands, touching things, praying, or counting coins.", "The character feels compelled to repeat a specific activity over and over, such as washing hands, touching things, praying, or counting coins.",
				"The character feels compelled to repeat a specific activity over and over, such as washing hands, touching things, praying, or counting coins.", "The character feels compelled to repeat a specific activity over and over, such as washing hands, touching things, praying, or counting coins.",
				...
				"The character experiences vivid hallucinations and has disadvantage on ability checks.", "The character experiences vivid hallucinations and has disadvantage on ability checks.",
				// 21-30
				"The character suffers extreme paranoia. The character has disadvantage on Wisdom and Charisma checks.", "The character suffers extreme paranoia. The character has disadvantage on Wisdom and Charisma checks.",
				"The character suffers extreme paranoia. The character has disadvantage on Wisdom and Charisma checks.", "The character suffers extreme paranoia. The character has disadvantage on Wisdom and Charisma checks.",
				"The character suffers extreme paranoia. The character has disadvantage on Wisdom and Charisma checks.", "The character suffers extreme paranoia. The character has disadvantage on Wisdom and Charisma checks.",
				"The character suffers extreme paranoia. The character has disadvantage on Wisdom and Charisma checks.", "The character suffers extreme paranoia. The character has disadvantage on Wisdom and Charisma checks.",
				"The character suffers extreme paranoia. The character has disadvantage on Wisdom and Charisma checks.", "The character suffers extreme paranoia. The character has disadvantage on Wisdom and Charisma checks.",
				// 31-40
				"The character regards something (usually the source of madness) with intense revulsion, as if affected by the antipathy effect of the antipathy/sympathy spell.", "The character regards something (usually the source of madness) with intense revulsion, as if affected by the antipathy effect of the antipathy/sympathy spell.",
				"The character regards something (usually the source of madness) with intense revulsion, as if affected by the antipathy effect of the antipathy/sympathy spell.", "The character regards something (usually the source of madness) with intense revulsion, as if affected by the antipathy effect of the antipathy/sympathy spell.",
				"The character regards something (usually the source of madness) with intense revulsion, as if affected by the antipathy effect of the antipathy/sympathy spell.", "The character regards something (usually the source of madness) with intense revulsion, as if affected by the antipathy effect of the antipathy/sympathy spell.",
				"The character regards something (usually the source of madness) with intense revulsion, as if affected by the antipathy effect of the antipathy/sympathy spell.", "The character regards something (usually the source of madness) with intense revulsion, as if affected by the antipathy effect of the antipathy/sympathy spell.",
				"The character regards something (usually the source of madness) with intense revulsion, as if affected by the antipathy effect of the antipathy/sympathy spell.", "The character regards something (usually the source of madness) with intense revulsion, as if affected by the antipathy effect of the antipathy/sympathy spell.",
				// 41-45
				"The character experiences a powerful delusion. Choose a potion. The character imagines that he or she is under its effects.", "The character experiences a powerful delusion. Choose a potion. The character imagines that he or she is under its effects.",
				"The character experiences a powerful delusion. Choose a potion. The character imagines that he or she is under its effects.", "The character experiences a powerful delusion. Choose a potion. The character imagines that he or she is under its effects.",
				"The character experiences a powerful delusion. Choose a potion. The character imagines that he or she is under its effects.",
				// 46-55
				"The character becomes attached to a \"lucky charm,\" such as a person or an object, and has disadvantage on attack rolls, ability checks, and saving throws while more than 30 feet form it.", "The character becomes attached to a \"lucky charm,\" such as a person or an object, and has disadvantage on attack rolls, ability checks, and saving throws while more than 30 feet form it.",
				"The character becomes attached to a \"lucky charm,\" such as a person or an object, and has disadvantage on attack rolls, ability checks, and saving throws while more than 30 feet form it.", "The character becomes attached to a \"lucky charm,\" such as a person or an object, and has disadvantage on attack rolls, ability checks, and saving throws while more than 30 feet form it.",
				"The character becomes attached to a \"lucky charm,\" such as a person or an object, and has disadvantage on attack rolls, ability checks, and saving throws while more than 30 feet form it.", "The character becomes attached to a \"lucky charm,\" such as a person or an object, and has disadvantage on attack rolls, ability checks, and saving throws while more than 30 feet form it.",
				"The character becomes attached to a \"lucky charm,\" such as a person or an object, and has disadvantage on attack rolls, ability checks, and saving throws while more than 30 feet form it.", "The character becomes attached to a \"lucky charm,\" such as a person or an object, and has disadvantage on attack rolls, ability checks, and saving throws while more than 30 feet form it.",
				"The character becomes attached to a \"lucky charm,\" such as a person or an object, and has disadvantage on attack rolls, ability checks, and saving throws while more than 30 feet form it.", "The character becomes attached to a \"lucky charm,\" such as a person or an object, and has disadvantage on attack rolls, ability checks, and saving throws while more than 30 feet form it.",
				// 56-65
				"The character is blinded (25%) or deafened (75%).", "The character is blinded (25%) or deafened (75%).",
				"The character is blinded (25%) or deafened (75%).", "The character is blinded (25%) or deafened (75%).",
				"The character is blinded (25%) or deafened (75%).", "The character is blinded (25%) or deafened (75%).",
				"The character is blinded (25%) or deafened (75%).", "The character is blinded (25%) or deafened (75%).",
				"The character is blinded (25%) or deafened (75%).", "The character is blinded (25%) or deafened (75%).",
				// 66-75
				"The character experiences uncontrollable tremors or tics, which impose disadvantage on attack rolls, ability checks, and saving throws that involve Strength or Dexterity.", "The character experiences uncontrollable tremors or tics, which impose disadvantage on attack rolls, ability checks, and saving throws that involve Strength or Dexterity.",
				"The character experiences uncontrollable tremors or tics, which impose disadvantage on attack rolls, ability checks, and saving throws that involve Strength or Dexterity.", "The character experiences uncontrollable tremors or tics, which impose disadvantage on attack rolls, ability checks, and saving throws that involve Strength or Dexterity.",
				"The character experiences uncontrollable tremors or tics, which impose disadvantage on attack rolls, ability checks, and saving throws that involve Strength or Dexterity.", "The character experiences uncontrollable tremors or tics, which impose disadvantage on attack rolls, ability checks, and saving throws that involve Strength or Dexterity.",
				"The character experiences uncontrollable tremors or tics, which impose disadvantage on attack rolls, ability checks, and saving throws that involve Strength or Dexterity.", "The character experiences uncontrollable tremors or tics, which impose disadvantage on attack rolls, ability checks, and saving throws that involve Strength or Dexterity.",
				"The character experiences uncontrollable tremors or tics, which impose disadvantage on attack rolls, ability checks, and saving throws that involve Strength or Dexterity.", "The character experiences uncontrollable tremors or tics, which impose disadvantage on attack rolls, ability checks, and saving throws that involve Strength or Dexterity.",
				// 76-85
				"The character suffers from partial amnesia. The character knows who he or she is and retains racial traits and class features, but doesn't recognize other people or remember anything that happened before the madness took effect.", "The character suffers from partial amnesia. The character knows who he or she is and retains racial traits and class features, but doesn't recognize other people or remember anything that happened before the madness took effect.",
				"The character suffers from partial amnesia. The character knows who he or she is and retains racial traits and class features, but doesn't recognize other people or remember anything that happened before the madness took effect.", "The character suffers from partial amnesia. The character knows who he or she is and retains racial traits and class features, but doesn't recognize other people or remember anything that happened before the madness took effect.",
				"The character suffers from partial amnesia. The character knows who he or she is and retains racial traits and class features, but doesn't recognize other people or remember anything that happened before the madness took effect.", "The character suffers from partial amnesia. The character knows who he or she is and retains racial traits and class features, but doesn't recognize other people or remember anything that happened before the madness took effect.",
				"The character suffers from partial amnesia. The character knows who he or she is and retains racial traits and class features, but doesn't recognize other people or remember anything that happened before the madness took effect.", "The character suffers from partial amnesia. The character knows who he or she is and retains racial traits and class features, but doesn't recognize other people or remember anything that happened before the madness took effect.",
				"The character suffers from partial amnesia. The character knows who he or she is and retains racial traits and class features, but doesn't recognize other people or remember anything that happened before the madness took effect.", "The character suffers from partial amnesia. The character knows who he or she is and retains racial traits and class features, but doesn't recognize other people or remember anything that happened before the madness took effect.",
				// 86-90
				"Whenever the character takes damage, he or she must succeed on a DC 15 Wisdom saving throw or be affected as though he or she failed a saving throw against the confusion spell. The confusion effect lasts for 1 minute.", "Whenever the character takes damage, he or she must succeed on a DC 15 Wisdom saving throw or be affected as though he or she failed a saving throw against the confusion spell. The confusion effect lasts for 1 minute.",
				"Whenever the character takes damage, he or she must succeed on a DC 15 Wisdom saving throw or be affected as though he or she failed a saving throw against the confusion spell. The confusion effect lasts for 1 minute.", "Whenever the character takes damage, he or she must succeed on a DC 15 Wisdom saving throw or be affected as though he or she failed a saving throw against the confusion spell. The confusion effect lasts for 1 minute.",
				...
				// 91-95
				"The character loses the ability to speak.", "The character loses the ability to speak.", "The character loses the ability to speak.",
				"The character loses the ability to speak.", "The character loses the ability to speak.",
				// 96-100
				"The character falls unconscious. No amount of jostling or damage can wake the character.", "The character falls unconscious. No amount of jostling or damage can wake the character.",
				"The character falls unconscious. No amount of jostling or damage can wake the character.", "The character falls unconscious. No amount of jostling or damage can wake the character.",
				"The character falls unconscious. No amount of jostling or damage can wake the character."
			};

			public static readonly string[] indefinite_madness =
			{
				// 01-15
				"Beng drunk keeps me sane.", "Beng drunk keeps me sane.", "Beng drunk keeps me sane.", "Beng drunk keeps me sane.", "Beng drunk keeps me sane.",
				"Beng drunk keeps me sane.", "Beng drunk keeps me sane.", "Beng drunk keeps me sane.", "Beng drunk keeps me sane.", "Beng drunk keeps me sane.",
				"Beng drunk keeps me sane.", "Beng drunk keeps me sane.", "Beng drunk keeps me sane.", "Beng drunk keeps me sane.", "Beng drunk keeps me sane.",
				// 16-25
				"I keep whatever I find.", "I keep whatever I find.", "I keep whatever I find.", "I keep whatever I find.", "I keep whatever I find.",
				"I keep whatever I find.", "I keep whatever I find.", "I keep whatever I find.", "I keep whatever I find.", "I keep whatever I find.",
				// 26-30
				"I try to become more like someone else I know -- adopting his or her style of dress, mannerisms, and name.", "I try to become more like someone else I know -- adopting his or her style of dress, mannerisms, and name.",
				"I try to become more like someone else I know -- adopting his or her style of dress, mannerisms, and name.", "I try to become more like someone else I know -- adopting his or her style of dress, mannerisms, and name.",
				"I try to become more like someone else I know -- adopting his or her style of dress, mannerisms, and name.",
				// 31-35
				"I must bend the truth, exaggerate, or outright lie to be interesting to other people.", "I must bend the truth, exaggerate, or outright lie to be interesting to other people.",
				"I must bend the truth, exaggerate, or outright lie to be interesting to other people.", "I must bend the truth, exaggerate, or outright lie to be interesting to other people.",
				"I must bend the truth, exaggerate, or outright lie to be interesting to other people.",
				// 36-45
				"Achieving my goal is the only thing of interest to me, and I'll ignore everything else to pursue it.", "Achieving my goal is the only thing of interest to me, and I'll ignore everything else to pursue it.",
				"Achieving my goal is the only thing of interest to me, and I'll ignore everything else to pursue it.", "Achieving my goal is the only thing of interest to me, and I'll ignore everything else to pursue it.",
				"Achieving my goal is the only thing of interest to me, and I'll ignore everything else to pursue it.", "Achieving my goal is the only thing of interest to me, and I'll ignore everything else to pursue it.",
				"Achieving my goal is the only thing of interest to me, and I'll ignore everything else to pursue it.", "Achieving my goal is the only thing of interest to me, and I'll ignore everything else to pursue it.",
				"Achieving my goal is the only thing of interest to me, and I'll ignore everything else to pursue it.", "Achieving my goal is the only thing of interest to me, and I'll ignore everything else to pursue it.",
				// 46-50
				"I find it hard to care about anything that goes on around me.", "I find it hard to care about anything that goes on around me.",
				"I find it hard to care about anything that goes on around me.", "I find it hard to care about anything that goes on around me.",
				"I find it hard to care about anything that goes on around me.",
				// 51-55
				"I don't like the way people judge me all the time.", "I don't like the way people judge me all the time.",
				"I don't like the way people judge me all the time.", "I don't like the way people judge me all the time.",
				"I don't like the way people judge me all the time.",
				// 56-70
				"I am the smartest, wisest, strongest, fastest, and most beautiful person I know.", "I am the smartest, wisest, strongest, fastest, and most beautiful person I know.", "I am the smartest, wisest, strongest, fastest, and most beautiful person I know.",
				"I am the smartest, wisest, strongest, fastest, and most beautiful person I know.", "I am the smartest, wisest, strongest, fastest, and most beautiful person I know.", "I am the smartest, wisest, strongest, fastest, and most beautiful person I know.",
				"I am the smartest, wisest, strongest, fastest, and most beautiful person I know.", "I am the smartest, wisest, strongest, fastest, and most beautiful person I know.", "I am the smartest, wisest, strongest, fastest, and most beautiful person I know.",
				"I am the smartest, wisest, strongest, fastest, and most beautiful person I know.", "I am the smartest, wisest, strongest, fastest, and most beautiful person I know.", "I am the smartest, wisest, strongest, fastest, and most beautiful person I know.",
				"I am the smartest, wisest, strongest, fastest, and most beautiful person I know.", "I am the smartest, wisest, strongest, fastest, and most beautiful person I know.", "I am the smartest, wisest, strongest, fastest, and most beautiful person I know.",
				// 71-80
				"I am convinced that powerful enemies are hunting me, and their agents are everywhere I go. I am sure they're watching me all the time.", "I am convinced that powerful enemies are hunting me, and their agents are everywhere I go. I am sure they're watching me all the time.",
				"I am convinced that powerful enemies are hunting me, and their agents are everywhere I go. I am sure they're watching me all the time.", "I am convinced that powerful enemies are hunting me, and their agents are everywhere I go. I am sure they're watching me all the time.",
				"I am convinced that powerful enemies are hunting me, and their agents are everywhere I go. I am sure they're watching me all the time.", "I am convinced that powerful enemies are hunting me, and their agents are everywhere I go. I am sure they're watching me all the time.",
				"I am convinced that powerful enemies are hunting me, and their agents are everywhere I go. I am sure they're watching me all the time.", "I am convinced that powerful enemies are hunting me, and their agents are everywhere I go. I am sure they're watching me all the time.",
				"I am convinced that powerful enemies are hunting me, and their agents are everywhere I go. I am sure they're watching me all the time.", "I am convinced that powerful enemies are hunting me, and their agents are everywhere I go. I am sure they're watching me all the time.",
				// 81-85
				"There's only one person I can truest. And only I can see this special friend.", "There's only one person I can truest. And only I can see this special friend.",
				"There's only one person I can truest. And only I can see this special friend.", "There's only one person I can truest. And only I can see this special friend.",
				"There's only one person I can truest. And only I can see this special friend.",
				// 86-95
				"I can't take anything seriously. The more serious the situation, the funnier I find it.", "I can't take anything seriously. The more serious the situation, the funnier I find it.",
				"I can't take anything seriously. The more serious the situation, the funnier I find it.", "I can't take anything seriously. The more serious the situation, the funnier I find it.",
				"I can't take anything seriously. The more serious the situation, the funnier I find it.", "I can't take anything seriously. The more serious the situation, the funnier I find it.",
				"I can't take anything seriously. The more serious the situation, the funnier I find it.", "I can't take anything seriously. The more serious the situation, the funnier I find it.",
				"I can't take anything seriously. The more serious the situation, the funnier I find it.", "I can't take anything seriously. The more serious the situation, the funnier I find it.",
				// 96-100
				"I've discovered that I really like killing people.", "I've discovered that I really like killing people.",
				"I've discovered that I really like killing people.", "I've discovered that I really like killing people.",
		...
		{
			public static readonly string[] lingering_injuries =
			{
				...
				"Internal Injury. Whenever you attempt an action in combat, you must make a DC 15 Constitution saving throw. On a failed save, you lose your action and cant use reactions until the start of your next turn. The injury heals if you receive magical healing or if you spend ten days doing nothing but resting.",
				"Internal Injury. Whenever you attempt an action in combat, you must make a DC 15 Constitution saving throw. On a failed save, you lose your action and cant use reactions until the start of your next turn. The injury heals if you receive magical healing or if you spend ten days doing nothing but resting.",
				"Internal Injury. Whenever you attempt an action in combat, you must make a DC 15 Constitution saving throw. On a failed save, you lose your action and cant use reactions until the start of your next turn. The injury heals if you receive magical healing or if you spend ten days doing nothing but resting.",
				"Broken Ribs. This has the same effect as Internal Injury above, except that the save DC is 10.",
				"Broken Ribs. This has the same effect as Internal Injury above, except that the save DC is 10.",
				"Broken Ribs. This has the same effect as Internal Injury above, except that the save DC is 10.",
				"Horribel Scar. You are disfigured to the extent that the wound can't be easily concealed. You have disadvantage on Charisma (Persuasion) checks and advantage on Charisma (Intimidation) checks. Magical healing of 6th level or higher, such as heal and regenerate, removes the scar.",
				"Horribel Scar. You are disfigured to the extent that the wound can't be easily concealed. You have disadvantage on Charisma (Persuasion) checks and advantage on Charisma (Intimidation) checks. Magical healing of 6th level or higher, such as heal and regenerate, removes the scar.",
				"Horribel Scar. You are disfigured to the extent that the wound can't be easily concealed. You have disadvantage on Charisma (Persuasion) checks and advantage on Charisma (Intimidation) checks. Magical healing of 6th level or higher, such as heal and regenerate, removes the scar.",
				"Festering Wound. Your hit point maximum is reduced by 1 every 24 hours the wound persists. If your hit point maximum drops to 0, you die. The wound heals if you receive magical healing. Alternatively, someone can tend to the wound and make a DC 15 Wisdom (Medicine) check once every 24 hours. After ten sucesses, the wound heals.",
				"Festering Wound. Your hit point maximum is reduced by 1 every 24 hours the wound persists. If your hit point maximum drops to 0, you die. The wound heals if you receive magical healing. Alternatively, someone can tend to the wound and make a DC 15 Wisdom (Medicine) check once every 24 hours. After ten sucesses, the wound heals.",
				"Festering Wound. Your hit point maximum is reduced by 1 every 24 hours the wound persists. If your hit point maximum drops to 0, you die. The wound heals if you receive magical healing. Alternatively, someone can tend to the wound and make a DC 15 Wisdom (Medicine) check once every 24 hours. After ten sucesses, the wound heals.",
			...
			public static readonly string[] system_shock =
			{
